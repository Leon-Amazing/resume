export const list = [
    ...
    content: [
      ...
      },
      {
        ...
        children: [
          ...
          '2. 负责直播模块的开发，对接 polyvSDK ，封装直播相关业务组件，兼容适配android、ios、公众号等平台；',
          '3. 使用骨架屏、懒加载技术、数据缓存、通过防抖和节流减少不必要的网络请求，将页面加载时间缩短了20%；',
          '4. 封装各种工具类、工具方法，请求 API 异常处理，如断网轮询处理机制。'
        ]
      }
    ]
  },
  {
    ...
    content: [
      ...
      {
        title: '技术栈',
        children: ['框架： 原生小程序API + Vant + JavaScript']
      },
      {
        title: '工作和成就',
        children: [
          '1. 负责 前端性能优化解决方案，搭建项目结构、代码规范等；',
          '2. 基于 Vant 封装公共组件。如： dialog 、 book-card 、 list-item ，代码量减少50%；',
          '3. 根据设计稿和用户体验原则，小程序的界面100%确保布局合理、美观，与产品风格一致；',
          '4. 优化小程序的加载速度和渲染性能，如首页缓存、骨架屏、无限滚动等，渲染性能提高20%。'
        ]
      }
    ]
  },
